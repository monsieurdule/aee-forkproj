pipeline {
    ...
    post {
        success {
            ...
            httpRequest acceptType: 'APPLICATION_JSON', consoleLogResponseBody: true, contentType: 'APPLICATION_JSON', httpMode: 'POST', requestBody: '{"result":"build success"}', responseHandle: 'NONE', url: 'http://192.168.10.200:3537/jenkins', validResponseCodes: '200', wrapAsMultipart: false
